  ...
  return (
    <section ref={containerRef} className="w-full flex flex-col-reverse lg:flex-row justify-between overflow-hidden bg-[url('/common/gradient-Bg.png')] bg-cover bg-center">
      <div className="w-full py-10 lg:py-20 px-6 md:px-20 overflow-hidden">
        {/* Header */}
        <div className="team-header mb-14 text-left">
        ...
        <div className="team-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {teamMembers.map((member, idx) => (
            <div key={idx} className="team-card h-full">
              <div 
                className="bg-white rounded-[12px] p-8 md:p-10 flex flex-col shadow-lg hover:-translate-y-1 transition-transform duration-300 h-full"
              >
                {/* Profile Image */}
