  ...
  return (
    <section ref={containerRef} className="w-full bg-white py-24 px-6 md:px-[20px] lg:px-20 overflow-hidden">
      <div className="max-w-[1440px] mx-auto">
        <h2 className="se-title text-[#2A3A6A] font-['Inter'] font-medium text-[36px] md:text-[42px] lg:text-[40px] tracking-normal mb-16 lg:mb-20">
            ...
            <div className="se-avatars-grid grid grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-12 max-w-[500px]">
              {teamMembers.map((img, idx) => (
                <div key={idx} className="se-avatar flex justify-center">
                  <div className="w-[110px] h-[110px] md:w-[135px] md:h-[135px] rounded-full bg-[#2A3A6A] overflow-hidden shadow-sm flex items-center justify-center">
                    <img 
                      src={img} 
